...
final class ServiceMethod<T> {
    ...
    Request toRequest(Object... args) throws IOException {
        RequestBuilder requestBuilder =
                new RequestBuilder(httpMethod, baseUrl, relativeUrl, headers, contentType, hasBody,
    ...
    static final class Builder<T> {
        ...
        private void parseHttpMethodAndPath(String httpMethod, String value, boolean hasBody) {
            if (this.httpMethod != null) {
                throw methodError("Only one HTTP method is allowed. Found: %s and %s.", this.httpMethod,
                                  httpMethod);
            }
        ...
        private ParameterHandler<?> parseParameterAnnotation(int p, Type type, Annotation[] annotations,
            ...
            if (annotation instanceof Url) {
                ...
                if (type == HttpUrl.class
                        || type == String.class
                        || type == URI.class
                        || (type instanceof Class && "android.net.Uri".equals(
                        ((Class<?>) type).getName()))) {
        ...
        private void validatePathName(int p, String name) {
            if (!PARAM_NAME_REGEX.matcher(name)
                    .matches()) {
        ...
        private RuntimeException methodError(Throwable cause, String message, Object... args) {
            ...
            return new IllegalArgumentException(message + "\n    for method " + method.getDeclaringClass()
                    .getSimpleName() + "." + method.getName(), cause);
        }
