...
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_callNativeStringArray(JNIEnv *env,
                                                                                 jobject thiz,
...
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_getIntArray(JNIEnv *env, jobject thiz,
                                                                       jint num) {
...
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_nativeSetNum(JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_accessInstanceField(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jobject animal) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_accessStaticField(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jobject animal) {
    jclass clazz = env->GetObjectClass(animal);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_baiiu_jnitest_referencePass_ReferencePassFragment_nativeCallMethod(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jobject animal) {
    jclass clazz = env->GetObjectClass(animal);
