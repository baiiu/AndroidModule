...
/**
 * Created with IntelliJ IDEA. User: will Date: 15/8/7 Time: 下午1:48 To change
...
public class UploadToRio {
	...
	public UploadToRio(String appId, String token, String appName, String versionName, String versionCode,
			String changeLog) {
		this.appId = appId;
